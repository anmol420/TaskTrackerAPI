...
public class Task {
    ...
    private TaskList taskList; // same name as mappedBy
    ...
    public Task(UUID id, LocalDateTime updated, LocalDateTime created, TaskPriority priority, TaskList taskList, TaskStatus status, String description, LocalDateTime dueDate, String title) {
        this.id = id;
